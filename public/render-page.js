...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6585);
...
/* harmony import */ var react_helmet__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8154);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1864);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4031);
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3208);
const StyledMainContainer=styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].main.withConfig({displayName:"pensieve__StyledMainContainer",componentId:"sc-jb5p05-0"})(["& > header{margin-bottom:100px;text-align:center;a{&:hover,&:focus{cursor:url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='40' height='48' viewport='0 0 100 100' style='fill:black;font-size:24px;'><text y='50%'>\u26A1</text></svg>\") 20 0,auto;}}}footer{",";width:100%;margin-top:20px;}"],({theme})=>theme.mixins.flexBetween);const StyledGrid=styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].ul.withConfig({displayName:"pensieve__StyledGrid",componentId:"sc-jb5p05-1"})(["",";display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));grid-gap:15px;margin-top:50px;position:relative;@media (max-width:1080px){grid-template-columns:repeat(auto-fill,minmax(250px,1fr));}"],({theme})=>theme.mixins.resetList);const StyledPost=styled_components__WEBPACK_IMPORTED_MODULE_5__["default"].li.withConfig({displayName:"pensieve__StyledPost",componentId:"sc-jb5p05-2"})(["transition:var(--transition);cursor:default;@media (prefers-reduced-motion:no-preference){&:hover,&:focus-within{.post__inner{transform:translateY(-7px);}}}a{position:relative;z-index:1;}.post__inner{",";",";flex-direction:column;align-items:flex-start;position:relative;height:100%;padding:2rem 1.75rem;border-radius:var(--border-radius);transition:var(--transition);background-color:var(--light-navy);header,a{width:100%;}}.post__icon{",";color:var(--green);margin-bottom:30px;margin-left:-5px;svg{width:40px;height:40px;}}.post__title{margin:0 0 10px;color:var(--lightest-slate);font-size:var(--fz-xxl);a{position:static;&:before{content:'';display:block;position:absolute;z-index:0;width:100%;height:100%;top:0;left:0;}}}.post__desc{color:var(--light-slate);font-size:17px;}.post__date{color:var(--light-slate);font-family:var(--font-mono);font-size:var(--fz-xxs);text-transform:uppercase;}ul.post__tags{display:flex;align-items:flex-end;flex-wrap:wrap;padding:0;margin:0;list-style:none;li{color:var(--green);font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:1.75;&:not(:last-of-type){margin-right:15px;}}}"],({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexBetween);const PensievePage=({location,data})=>{const posts=data.allMarkdownRemark.edges;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_6__/* .Layout */ .PE,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_4__.Helmet,{title:"Pensieve"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"big-heading"},"Pensieve"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"subtitle"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:"https://www.wizardingworld.com/writing-by-jk-rowling/pensieve"},"a collection of memories"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledGrid,null,posts.length>0&&posts.map(({node},i)=>{const{frontmatter}=node;const{title,description,slug,date,tags}=frontmatter;const formattedDate=new Date(date).toLocaleDateString();return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledPost,{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"post__inner"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"post__icon"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_7__/* .IconBookmark */ .Ed,null)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h5",{className:"post__title"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:slug},title)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"post__desc"},description)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("footer",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{className:"post__date"},formattedDate),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",{className:"post__tags"},tags.map((tag,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:`/pensieve/tags/${lodash_kebabCase__WEBPACK_IMPORTED_MODULE_2___default()(tag)}/`,className:"inline-link"},"#",tag)))))));}))));};PensievePage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object).isRequired,data:(prop_types__WEBPACK_IMPORTED_MODULE_3___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PensievePage);const pageQuery="2420531667";
...
// EXTERNAL MODULE: external "D:\\myfiles\\portfolio\\cyber-portfolio\\node_modules\\react\\index.js"
var external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_ = __webpack_require__(6585);
;// ./src/hooks/useOnClickOutside.js
// https://usehooks.com/useOnClickOutside/
const useOnClickOutside=(ref,handler)=>{(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{const listener=event=>{// Do nothing if clicking ref's element or descendent elements
...
// occur.
isRenderingOnServer?true:!window.matchMedia(QUERY).matches;function usePrefersReducedMotion(){const{0:prefersReducedMotion,1:setPrefersReducedMotion}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(getInitialState);(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{const mediaQueryList=window.matchMedia(QUERY);const listener=event=>{setPrefersReducedMotion(!event.matches);};mediaQueryList.addListener(listener);return()=>{mediaQueryList.removeListener(listener);};},[]);return prefersReducedMotion;}/* harmony default export */ const hooks_usePrefersReducedMotion = (usePrefersReducedMotion);
;// ./src/hooks/useScrollDirection.js
const SCROLL_UP='up';const SCROLL_DOWN='down';const useScrollDirection=({initialDirection,thresholdPixels,off}={})=>{const{0:scrollDir,1:setScrollDir}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(initialDirection);(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{const threshold=thresholdPixels||0;let lastScrollY=window.pageYOffset;let ticking=false;const updateScrollDir=()=>{const scrollY=window.pageYOffset;if(Math.abs(scrollY-lastScrollY)<threshold){// We haven't exceeded the threshold
...
// EXTERNAL MODULE: external "D:\\myfiles\\portfolio\\cyber-portfolio\\node_modules\\react\\index.js"
var external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_ = __webpack_require__(6585);
var external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_);
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  ...
  return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
...
}((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Component);
    ...
    function (baseContext) {
      return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
        ...
        external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
module.exports={email:'shirshak831@gmail.com',socialMedia:[{name:'GitHub',url:'https://github.com/Shirshakhtml'},{name:'Twitter',url:'https://x.com/Shirsha98901922'},{name:'Linkedin',url:'https://www.linkedin.com/in/shirshak-pentester/'}],navLinks:[{name:'About',url:'/#about'},{name:'Experience',url:'/#jobs'},{name:'Work',url:'/#projects'},{name:'Blog',url:'/blog'},{name:'Contact',url:'/#contact'}],colors:{green:'#64ffda',navy:'#0a192f',darkNavy:'#020c1b'},srConfig:(delay=200,viewFactor=0.25)=>({origin:'bottom',distance:'20px',duration:500,delay,rotate:{x:0,y:0,z:0},opacity:0,scale:1,easing:'cubic-bezier(0.645, 0.045, 0.355, 1)',mobile:true,reset:false,useDelay:'always',viewFactor,viewOffset:{top:0,right:0,bottom:0,left:0}})};
...
var React = __webpack_require__(6585);
...
*/
var aa=__webpack_require__(6585),m=__webpack_require__(8828),r=__webpack_require__(9982);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
// EXTERNAL MODULE: ./src/components/layout.js + 28 modules
var layout = __webpack_require__(8785);
// EXTERNAL MODULE: ./src/components/seo.js
var seo = __webpack_require__(8629);
;// external "crypto"
...
function SnakeGame(){const canvasRef=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{// Prevent Gatsby SSR crash
if(typeof window==="undefined"||typeof document==="undefined")return;const canvas=canvasRef.current;if(!canvas)return;// safeguard
const ctx=canvas.getContext("2d");let snake=[{x:160,y:160}];let food={x:320,y:320};let dx=16;let dy=0;function draw(){ctx.fillStyle="#0a192f";ctx.fillRect(0,0,640,480);ctx.fillStyle="#64ffda";snake.forEach(p=>ctx.fillRect(p.x,p.y,16,16));ctx.fillStyle="#ff6b6b";ctx.fillRect(food.x,food.y,16,16);const head={x:snake[0].x+dx,y:snake[0].y+dy};snake.unshift(head);if(head.x===food.x&&head.y===food.y){food={x:Math.floor(Math.random()*40)*16,y:Math.floor(Math.random()*30)*16};}else{snake.pop();}if(head.x<0||head.y<0||head.x>=640||head.y>=480||snake.slice(1).some(p=>p.x===head.x&&p.y===head.y)){snake=[{x:160,y:160}];dx=16;dy=0;}}function keyHandler(e){if(e.key==="ArrowUp"&&dy===0)dx=0,dy=-16;else if(e.key==="ArrowDown"&&dy===0)dx=0,dy=16;else if(e.key==="ArrowLeft"&&dx===0)dx=-16,dy=0;else if(e.key==="ArrowRight"&&dx===0)dx=16,dy=0;}document.addEventListener("keydown",keyHandler);const game=setInterval(draw,100);return()=>{clearInterval(game);document.removeEventListener("keydown",keyHandler);};},[]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{style:{display:"flex",justifyContent:"center",marginTop:"2rem"}},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("canvas",{ref:canvasRef,width:640,height:480,style:{border:"2px solid #64ffda",borderRadius:"8px",background:"#0a192f"}}));}
;// ./src/pages/blog.js
/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(PageWrapper,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h1",null,"Blog"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(SnakeGame,null),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(BlogGrid,null," ... "));/* ----------  PAGE WRAPPER  ---------- */const PageWrapper=styled_components_esm["default"].div.withConfig({displayName:"blog__PageWrapper",componentId:"sc-11qlws1-0"})(["max-width:1100px;margin:0 auto;padding:4rem 2rem;padding-top:calc(var(--nav-height) + 2rem);"]);/* ----------  GRID  ---------- */const BlogGrid=styled_components_esm["default"].div.withConfig({displayName:"blog__BlogGrid",componentId:"sc-11qlws1-1"})(["display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:2.5rem;margin-top:3rem;"]);/* ----------  CARD  ---------- */const BlogCard=(0,styled_components_esm["default"])(gatsby_browser_entry.Link).withConfig({displayName:"blog__BlogCard",componentId:"sc-11qlws1-2"})(["display:block;background:rgba(10,25,47,0.55);backdrop-filter:blur(10px);border:1px solid rgba(100,255,218,0.15);border-radius:16px;overflow:hidden;text-decoration:none;color:#ccd6f6;transition:all 0.3s ease;&:hover{transform:translateY(-6px);box-shadow:0 12px 28px rgba(0,255,200,0.18);border-color:rgba(100,255,218,0.45);}"]);const Thumbnail=styled_components_esm["default"].div.withConfig({displayName:"blog__Thumbnail",componentId:"sc-11qlws1-3"})(["height:180px;background-size:cover;background-position:center;background-repeat:no-repeat;"]);const Content=styled_components_esm["default"].div.withConfig({displayName:"blog__Content",componentId:"sc-11qlws1-4"})(["padding:1.4rem 1.6rem;h3{margin:0 0 0.4rem;font-size:1.2rem;font-weight:600;color:#e6f1ff;}.date{font-size:0.9rem;color:#8892b0;margin-bottom:0.8rem;}.readmore{margin-top:1rem;color:#64ffda;font-size:0.95rem;transition:0.2s;&:hover{color:#00f5ff;}}"]);/* ---------- SAFE IMAGE RESOLVER ---------- */const resolveImage=imageField=>{if(!imageField)return"/default.jpg";// fallback
return imageField.publicURL||"/default.jpg";};/* ----------  COMPONENT  ---------- */function BlogIndex({data}){const posts=data.allMarkdownRemark.nodes;return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(layout/* default */.A,{isHome:false},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(seo/* default */.A,{title:"Blog"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(PageWrapper,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h1",null,"Blog"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(BlogGrid,null,posts.map(({id,frontmatter,fields})=>{const uuid=nanoid(6);const imageUrl=resolveImage(frontmatter.image);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(BlogCard,{key:id,to:`${fields.slug}?v=${uuid}`},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Thumbnail,{style:{backgroundImage:`url(${imageUrl})`}}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Content,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h3",null,frontmatter.title),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("p",{className:"date"},frontmatter.date),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",{className:"readmore"},"Read more \u2192")));}))));}/* ----------  GRAPHQL  ---------- */const query="420675991";
...
const preferDefault=m=>m&&m.default||m;exports.components={"component---cache-caches-gatsby-plugin-offline-app-shell-js":preferDefault(__webpack_require__(8826)),"component---src-pages-404-js":preferDefault(__webpack_require__(7412)),"component---src-pages-archive-js":preferDefault(__webpack_require__(4342)),"component---src-pages-blog-js":preferDefault(__webpack_require__(2858)),"component---src-pages-index-js":preferDefault(__webpack_require__(5608)),"component---src-pages-pensieve-index-js":preferDefault(__webpack_require__(934)),"component---src-pages-pensieve-tags-js":preferDefault(__webpack_require__(7653)),"component---src-templates-blog-post-js":preferDefault(__webpack_require__(9298)),"component---src-templates-post-js":preferDefault(__webpack_require__(7081)),"component---src-templates-tag-js":preferDefault(__webpack_require__(4843))};
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"app":["/app-7bd28ccd544d2ccd3f29.js"],"component---cache-caches-gatsby-plugin-offline-app-shell-js":["/component---cache-caches-gatsby-plugin-offline-app-shell-js-6f061b09cc63f0400406.js"],"component---src-pages-404-js":["/component---src-pages-404-js-24d1c518d26688112128.js"],"component---src-pages-archive-js":["/component---src-pages-archive-js-2022c81656890e4ad30a.js"],"component---src-pages-blog-js":["/component---src-pages-blog-js-b0df2c02f7caac596c88.js"],"component---src-pages-index-js":["/component---src-pages-index-js-baa920dd73186dd6cb55.js"],"component---src-pages-pensieve-index-js":["/component---src-pages-pensieve-index-js-73c98877b083335c8272.js"],"component---src-pages-pensieve-tags-js":["/component---src-pages-pensieve-tags-js-d60beebc554d00641133.js"],"component---src-templates-blog-post-js":["/component---src-templates-blog-post-js-2fcdcf06510b3b02af05.js"],"component---src-templates-post-js":["/component---src-templates-post-js-758a52b76b572a709754.js"],"component---src-templates-tag-js":["/component---src-templates-tag-js-018b58f5f65aec28c846.js"]}');
...
const IconAppStore=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{version:"1.1",xmlns:"http://www.w3.org/2000/svg",x:"0px",y:"0px",viewBox:"0 0 512 512",xmlSpace:"preserve"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Apple App Store"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M407,0H105C47.103,0,0,47.103,0,105v302c0,57.897,47.103,105,105,105h302c57.897,0,105-47.103,105-105V105\r C512,47.103,464.897,0,407,0z M482,407c0,41.355-33.645,75-75,75H105c-41.355,0-75-33.645-75-75V105c0-41.355,33.645-75,75-75h302\r c41.355,0,75,33.645,75,75V407z"}))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M305.646,123.531c-1.729-6.45-5.865-11.842-11.648-15.18c-11.936-6.892-27.256-2.789-34.15,9.151L256,124.166\r l-3.848-6.665c-6.893-11.937-22.212-16.042-34.15-9.151h-0.001c-11.938,6.893-16.042,22.212-9.15,34.151l18.281,31.664\r L159.678,291H110.5c-13.785,0-25,11.215-25,25c0,13.785,11.215,25,25,25h189.86l-28.868-50h-54.079l85.735-148.498\r C306.487,136.719,307.375,129.981,305.646,123.531z"}))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M401.5,291h-49.178l-55.907-96.834l-28.867,50l86.804,150.348c3.339,5.784,8.729,9.921,15.181,11.65\r c2.154,0.577,4.339,0.863,6.511,0.863c4.332,0,8.608-1.136,12.461-3.361c11.938-6.893,16.042-22.213,9.149-34.15L381.189,341\r H401.5c13.785,0,25-11.215,25-25C426.5,302.215,415.285,291,401.5,291z"}))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M119.264,361l-4.917,8.516c-6.892,11.938-2.787,27.258,9.151,34.15c3.927,2.267,8.219,3.345,12.458,3.344\r c8.646,0,17.067-4.484,21.693-12.495L176.999,361H119.264z"}))));/* harmony default export */ const appstore = (IconAppStore);
;// ./src/components/icons/bookmark.js
const IconBookmark=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-bookmark"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Bookmark"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"}));/* harmony default export */ const bookmark = (IconBookmark);
;// ./src/components/icons/codepen.js
const IconCodepen=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-codepen"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"CodePen"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polygon",{points:"12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("line",{x1:"12",y1:"22",x2:"12",y2:"15.5"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polyline",{points:"22 8.5 12 15.5 2 8.5"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polyline",{points:"2 15.5 12 8.5 22 15.5"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("line",{x1:"12",y1:"2",x2:"12",y2:"8.5"}));/* harmony default export */ const codepen = (IconCodepen);
;// ./src/components/icons/external.js
const IconExternal=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-external-link"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"External Link"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polyline",{points:"15 3 21 3 21 9"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("line",{x1:"10",y1:"14",x2:"21",y2:"3"}));/* harmony default export */ const external = (IconExternal);
;// ./src/components/icons/folder.js
const IconFolder=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-folder"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Folder"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"}));/* harmony default export */ const folder = (IconFolder);
;// ./src/components/icons/fork.js
const IconFork=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-git-branch"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Git Fork"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("line",{x1:"6",y1:"3",x2:"6",y2:"15"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("circle",{cx:"18",cy:"6",r:"3"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("circle",{cx:"6",cy:"18",r:"3"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M18 9a9 9 0 0 1-9 9"}));/* harmony default export */ const fork = (IconFork);
// EXTERNAL MODULE: ./node_modules/prop-types/index.js
var prop_types = __webpack_require__(5556);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
;// ./src/components/icons/icon.js
const Icon=({name})=>{switch(name){case'AppStore':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(appstore,null);case'Bookmark':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(bookmark,null);case'Codepen':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(codepen,null);case'External':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(external,null);case'Folder':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(folder,null);case'Fork':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(fork,null);case'GitHub':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(github,null);case'Instagram':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(instagram,null);case'Linkedin':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(linkedin,null);case'Loader':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(loader,null);case'Logo':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(logo,null);case'PlayStore':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(playstore,null);case'Star':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(star,null);case'Twitter':return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(twitter,null);default:return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(external,null);}};Icon.propTypes={name:(prop_types_default()).string.isRequired};/* harmony default export */ const icon = (Icon);
;// ./src/components/icons/github.js
const IconGitHub=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-github"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"GitHub"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"}));/* harmony default export */ const github = (IconGitHub);
;// ./src/components/icons/hex.js
const IconHex=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{id:"hex",xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 84 96"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Hexagon"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",{transform:"translate(-8.000000, -2.000000)"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",{transform:"translate(11.000000, 5.000000)"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polygon",{stroke:"currentColor",strokeWidth:"5",strokeLinecap:"round",strokeLinejoin:"round",points:"39 0 0 22 0 67 39 90 78 68 78 23",fill:"currentColor"}))));/* harmony default export */ const hex = (IconHex);
;// ./src/components/icons/instagram.js
const IconInstagram=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-instagram"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Instagram"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("rect",{x:"2",y:"2",width:"20",height:"20",rx:"5",ry:"5"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("line",{x1:"17.5",y1:"6.5",x2:"17.51",y2:"6.5"}));/* harmony default export */ const instagram = (IconInstagram);
;// ./src/components/icons/linkedin.js
const IconLinkedin=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-linkedin"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"LinkedIn"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("rect",{x:"2",y:"9",width:"4",height:"12"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("circle",{cx:"4",cy:"4",r:"2"}));/* harmony default export */ const linkedin = (IconLinkedin);
;// ./src/components/icons/loader.js
const IconLoader=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{id:"logo",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 100 100"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Loader Logo"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("text",{x:"50",y:"60",textAnchor:"middle",fontSize:"40",fontFamily:"Arial, Helvetica, sans-serif",fill:"currentColor"},"S"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{stroke:"currentColor",strokeWidth:"5",strokeLinecap:"round",strokeLinejoin:"round",d:"M 50, 5\r L 11, 27\r L 11, 72\r L 50, 95\r L 89, 73\r L 89, 28 z"})));/* harmony default export */ const loader = (IconLoader);
;// ./src/components/icons/logo.js
const IconLogo=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{id:"logo",xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 84 96"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Logo"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",{transform:"translate(-8.000000, -2.000000)"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("g",{transform:"translate(11.000000, 5.000000)"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polygon",{id:"Shape",stroke:"currentColor",strokeWidth:"5",strokeLinecap:"round",strokeLinejoin:"round",points:"39 0 0 22 0 67 39 90 78 68 78 23"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("text",{x:"39"// horizontal center of hexagon
,y:"58"// vertical positioning
,textAnchor:"middle",fontSize:"40",fontFamily:"Arial, Helvetica, sans-serif",fill:"currentColor"},"S"))));/* harmony default export */ const logo = (IconLogo);
;// ./src/components/icons/playstore.js
const IconPlayStore=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",x:"0px",y:"0px",viewBox:"0 0 512.001 512.001"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Google Play Store"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M464.252,212.09L99.624,8.07C84.247-1.873,64.754-2.691,48.574,5.967C32.183,14.74,22,31.737,22,50.329v411.342\r c0,18.592,10.183,35.59,26.573,44.361c16.097,8.617,35.593,7.891,51.052-2.101l364.628-204.022\r c16.121-9.02,25.747-25.435,25.747-43.908C490,237.527,480.374,221.111,464.252,212.09z M341.677,181.943l-50.339,50.339\r L113.108,54.051L341.677,181.943z M55.544,467.323V44.676L267.621,256L55.544,467.323z M113.108,457.949l178.232-178.231\r l50.339,50.339L113.108,457.949z M447.874,270.637l-75.779,42.401l-57.038-57.037l57.037-57.037l75.778,42.4\r c7.746,4.335,8.583,11.68,8.583,14.637C456.455,258.958,455.62,266.302,447.874,270.637z"}));/* harmony default export */ const playstore = (IconPlayStore);
;// ./src/components/icons/star.js
const IconStar=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-star"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Star"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"}));/* harmony default export */ const star = (IconStar);
;// ./src/components/icons/twitter.js
const IconTwitter=()=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("svg",{xmlns:"http://www.w3.org/2000/svg",role:"img",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",className:"feather feather-twitter"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("title",null,"Twitter"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("path",{d:"M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"}));/* harmony default export */ const twitter = (IconTwitter);
...
var React = _interopRequireWildcard(__webpack_require__(6585));
...
var _react = __webpack_require__(6585);
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"layout":"constrained","backgroundColor":"#f8f8f8","images":{"fallback":{"src":"/static/26469499daf848c0eb7a115a79fae973/797ff/me.jpg","srcSet":"/static/26469499daf848c0eb7a115a79fae973/f7f5b/me.jpg 125w,\\n/static/26469499daf848c0eb7a115a79fae973/39e0f/me.jpg 250w,\\n/static/26469499daf848c0eb7a115a79fae973/797ff/me.jpg 500w,\\n/static/26469499daf848c0eb7a115a79fae973/88ef1/me.jpg 1000w","sizes":"(min-width: 500px) 500px, 100vw"},"sources":[{"srcSet":"/static/26469499daf848c0eb7a115a79fae973/cf74e/me.avif 125w,\\n/static/26469499daf848c0eb7a115a79fae973/3858d/me.avif 250w,\\n/static/26469499daf848c0eb7a115a79fae973/29c1f/me.avif 500w,\\n/static/26469499daf848c0eb7a115a79fae973/b2bf9/me.avif 1000w","type":"image/avif","sizes":"(min-width: 500px) 500px, 100vw"},{"srcSet":"/static/26469499daf848c0eb7a115a79fae973/b71d6/me.webp 125w,\\n/static/26469499daf848c0eb7a115a79fae973/054ec/me.webp 250w,\\n/static/26469499daf848c0eb7a115a79fae973/68def/me.webp 500w,\\n/static/26469499daf848c0eb7a115a79fae973/ac8d4/me.webp 1000w","type":"image/webp","sizes":"(min-width: 500px) 500px, 100vw"}]},"width":500,"height":646}');
...
__webpack_require__.d(__webpack_exports__, {
  ...
  Bv: () => (/* reexport */ contact),
  Ps: () => (/* reexport */ email),
  Hi: () => (/* reexport */ featured),
  wi: () => (/* reexport */ footer),
  p3: () => (/* reexport */ head),
  lq: () => (/* reexport */ hero),
  XP: () => (/* reexport */ jobs),
  PE: () => (/* reexport */ layout/* default */.A),
  aH: () => (/* reexport */ loader),
  W1: () => (/* reexport */ menu),
  so: () => (/* reexport */ nav),
...
const Head=({title,description,image})=>{const{pathname}=(0,es.useLocation)();const{site}=(0,gatsby_browser_entry.useStaticQuery)("1994492073");const{defaultTitle,defaultDescription,siteUrl,defaultImage,twitterUsername}=site.siteMetadata;const seo={title:title||defaultTitle,description:description||defaultDescription,image:`${siteUrl}${image||defaultImage}`,url:`${siteUrl}${pathname}`};return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Helmet.Helmet,{title:title,defaultTitle:seo.title,titleTemplate:`%s | ${defaultTitle}`},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("html",{lang:"en"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"description",content:seo.description}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"image",content:seo.image}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{property:"og:title",content:seo.title}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{property:"og:description",content:seo.description}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{property:"og:image",content:seo.image}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{property:"og:url",content:seo.url}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{property:"og:type",content:"website"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"twitter:card",content:"summary_large_image"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"twitter:creator",content:twitterUsername}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"twitter:title",content:seo.title}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"twitter:description",content:seo.description}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"twitter:image",content:seo.image}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("meta",{name:"google-site-verification",content:"DCl7VAf9tcz6eD9gb67NfkNnJ1PKRNcg8qQiwpbx9Lk"}));};/* harmony default export */ const head = (Head);Head.propTypes={title:(prop_types_default()).string,description:(prop_types_default()).string,image:(prop_types_default()).string};Head.defaultProps={title:null,description:null,image:null};
// EXTERNAL MODULE: ./src/components/layout.js + 28 modules
var layout = __webpack_require__(8785);
...
const StyledLoader=styled_components_esm["default"].div.withConfig({displayName:"loader__StyledLoader",componentId:"sc-177se4j-0"})(["",";position:fixed;top:0;bottom:0;left:0;right:0;width:100%;height:100%;background-color:var(--dark-navy);z-index:99;.logo-wrapper{width:max-content;max-width:100px;transition:var(--transition);opacity:",";svg{display:block;width:100%;height:100%;margin:0 auto;fill:none;user-select:none;#B{opacity:0;}}}"],({theme})=>theme.mixins.flexCenter,props=>props.isMounted?1:0);const Loader=({finishLoading})=>{const{0:isMounted,1:setIsMounted}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(false);const animate=()=>{const loader=anime_es_default().timeline({complete:()=>finishLoading()});loader.add({targets:'#logo path',delay:300,duration:1500,easing:'easeInOutQuart',strokeDashoffset:[(anime_es_default()).setDashoffset,0]}).add({targets:'#logo #B',duration:700,easing:'easeInOutQuart',opacity:1}).add({targets:'#logo',delay:500,duration:300,easing:'easeInOutQuart',opacity:0,scale:0.1}).add({targets:'.loader',duration:200,easing:'easeInOutQuart',opacity:0,zIndex:-1});};(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{const timeout=setTimeout(()=>setIsMounted(true),10);animate();return()=>clearTimeout(timeout);},[]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledLoader,{className:"loader",isMounted:isMounted},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Helmet.Helmet,{bodyAttributes:{class:`hidden`}}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"logo-wrapper"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* IconLoader */.x3,null)));};Loader.propTypes={finishLoading:(prop_types_default()).func.isRequired};/* harmony default export */ const loader = (Loader);
...
const StyledHeader=styled_components_esm["default"].header.withConfig({displayName:"nav__StyledHeader",componentId:"sc-ghklvd-0"})(["",";position:fixed;top:0;z-index:11;padding:0px 50px;width:100%;height:var(--nav-height);background-color:rgba(10,25,47,0.85);filter:none !important;pointer-events:auto !important;user-select:auto !important;backdrop-filter:blur(10px);transition:var(--transition);@media (max-width:1080px){padding:0 40px;}@media (max-width:768px){padding:0 25px;}@media (prefers-reduced-motion:no-preference){",";",";}"],({theme})=>theme.mixins.flexBetween,props=>props.scrollDirection==='up'&&!props.scrolledToTop&&(0,styled_components_esm.css)(["height:var(--nav-scroll-height);transform:translateY(0px);background-color:rgba(10,25,47,0.85);box-shadow:0 10px 30px -10px var(--navy-shadow);"]),props=>props.scrollDirection==='down'&&!props.scrolledToTop&&(0,styled_components_esm.css)(["height:var(--nav-scroll-height);transform:translateY(calc(var(--nav-scroll-height) * -1));box-shadow:0 10px 30px -10px var(--navy-shadow);"]));const StyledNav=styled_components_esm["default"].nav.withConfig({displayName:"nav__StyledNav",componentId:"sc-ghklvd-1"})(["",";position:relative;width:100%;color:var(--lightest-slate);font-family:var(--font-mono);counter-reset:item 0;z-index:12;.logo{",";a{color:var(--green);width:42px;height:42px;position:relative;z-index:1;.hex-container{position:absolute;top:0;left:0;z-index:-1;@media (prefers-reduced-motion:no-preference){transition:var(--transition);}}.logo-container{position:relative;z-index:1;svg{fill:none;user-select:none;@media (prefers-reduced-motion:no-preference){transition:var(--transition);}polygon{fill:var(--navy);}}}&:hover,&:focus{outline:0;transform:translate(-4px,-4px);.hex-container{transform:translate(4px,3px);}}}}"],({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexCenter);const StyledLinks=styled_components_esm["default"].div.withConfig({displayName:"nav__StyledLinks",componentId:"sc-ghklvd-2"})(["display:flex;align-items:center;@media (max-width:768px){display:none;}ol{",";padding:0;margin:0;list-style:none;li{margin:0 5px;position:relative;counter-increment:item 1;font-size:var(--fz-xs);a{padding:10px;&:before{content:'0' counter(item) '.';margin-right:5px;color:var(--green);font-size:var(--fz-xxs);text-align:right;}}}}"],({theme})=>theme.mixins.flexBetween);const Nav=({isHome})=>{const{0:isMounted,1:setIsMounted}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(!isHome);const scrollDirection=(0,hooks/* useScrollDirection */.YU)('down');const{0:scrolledToTop,1:setScrolledToTop}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(true);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.jt)();const handleScroll=()=>{setScrolledToTop(window.pageYOffset<50);};(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}const timeout=setTimeout(()=>{setIsMounted(true);},100);window.addEventListener('scroll',handleScroll);return()=>{clearTimeout(timeout);window.removeEventListener('scroll',handleScroll);};},[]);const timeout=utils/* loaderDelay */.Zc;// always run transition
const fadeClass='fade';const fadeDownClass='fadedown';const Logo=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"logo",tabIndex:"-1"},isHome?/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:"/","aria-label":"home"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"hex-container"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* IconHex */.Xz,null)),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"logo-container"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* IconLogo */.H_,null))):/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/","aria-label":"home"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"hex-container"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* IconHex */.Xz,null)),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"logo-container"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* IconLogo */.H_,null))));return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledHeader,{scrollDirection:scrollDirection,scrolledToTop:scrolledToTop},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledNav,null,prefersReducedMotion?/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,Logo,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(menu,null)):/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroup/* default */.A,{component:null},isMounted&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{classNames:fadeClass,timeout:timeout},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,Logo))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledLinks,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("ol",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroup/* default */.A,{component:null},isMounted&&config.navLinks&&config.navLinks.map(({url,name},i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{key:i,classNames:fadeDownClass,timeout:timeout},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("li",{key:i,style:{transitionDelay:`${isHome?i*100:0}ms`}},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:url},name))))))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroup/* default */.A,{component:null},isMounted&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{classNames:fadeClass,timeout:timeout},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(menu,null))))));};Nav.propTypes={isHome:(prop_types_default()).bool};/* harmony default export */ const nav = (Nav);
;// ./src/components/menu.js
const StyledMenu=styled_components_esm["default"].div.withConfig({displayName:"menu__StyledMenu",componentId:"sc-sdn9y6-0"})(["display:none;@media (max-width:768px){display:block;}"]);const StyledHamburgerButton=styled_components_esm["default"].button.withConfig({displayName:"menu__StyledHamburgerButton",componentId:"sc-sdn9y6-1"})(["display:none;@media (max-width:768px){",";position:relative;z-index:10;margin-right:-15px;padding:15px;border:0;background-color:transparent;color:inherit;text-transform:none;transition-timing-function:linear;transition-duration:0.15s;transition-property:opacity,filter;}.ham-box{display:inline-block;position:relative;width:var(--hamburger-width);height:24px;}.ham-box-inner{position:absolute;top:50%;right:0;width:var(--hamburger-width);height:2px;border-radius:var(--border-radius);background-color:var(--green);transition-duration:0.22s;transition-property:transform;transition-delay:",";transform:rotate(",");transition-timing-function:cubic-bezier( "," );&:before,&:after{content:'';display:block;position:absolute;left:auto;right:0;width:var(--hamburger-width);height:2px;border-radius:4px;background-color:var(--green);transition-timing-function:ease;transition-duration:0.15s;transition-property:transform;}&:before{width:",";top:",";opacity:",";transition:",";}&:after{width:",";bottom:",";transform:rotate(",");transition:",";}}"],({theme})=>theme.mixins.flexCenter,props=>props.menuOpen?`0.12s`:`0s`,props=>props.menuOpen?`225deg`:`0deg`,props=>props.menuOpen?`0.215, 0.61, 0.355, 1`:`0.55, 0.055, 0.675, 0.19`,props=>props.menuOpen?`100%`:`120%`,props=>props.menuOpen?`0`:`-10px`,props=>props.menuOpen?0:1,({menuOpen})=>menuOpen?'var(--ham-before-active)':'var(--ham-before)',props=>props.menuOpen?`100%`:`80%`,props=>props.menuOpen?`0`:`-10px`,props=>props.menuOpen?`-90deg`:`0`,({menuOpen})=>menuOpen?'var(--ham-after-active)':'var(--ham-after)');const StyledSidebar=styled_components_esm["default"].aside.withConfig({displayName:"menu__StyledSidebar",componentId:"sc-sdn9y6-2"})(["display:none;@media (max-width:768px){",";position:fixed;top:0;bottom:0;right:0;padding:50px 10px;width:min(75vw,400px);height:100vh;outline:0;background-color:var(--light-navy);box-shadow:-10px 0px 30px -15px var(--navy-shadow);z-index:9;transform:translateX(","vw);visibility:",";transition:var(--transition);}nav{",";width:100%;flex-direction:column;color:var(--lightest-slate);font-family:var(--font-mono);text-align:center;}ol{padding:0;margin:0;list-style:none;width:100%;li{position:relative;margin:0 auto 20px;counter-increment:item 1;font-size:clamp(var(--fz-sm),4vw,var(--fz-lg));@media (max-width:600px){margin:0 auto 10px;}&:before{content:'0' counter(item) '.';display:block;margin-bottom:5px;color:var(--green);font-size:var(--fz-sm);}}a{",";width:100%;padding:3px 20px 20px;}}"],({theme})=>theme.mixins.flexCenter,props=>props.menuOpen?0:100,props=>props.menuOpen?'visible':'hidden',({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.link);const Menu=()=>{const{0:menuOpen,1:setMenuOpen}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(false);const toggleMenu=()=>setMenuOpen(!menuOpen);const buttonRef=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);const navRef=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);let menuFocusables;let firstFocusableEl;let lastFocusableEl;const setFocusables=()=>{menuFocusables=[buttonRef.current,...Array.from(navRef.current.querySelectorAll('a'))];firstFocusableEl=menuFocusables[0];lastFocusableEl=menuFocusables[menuFocusables.length-1];};const handleBackwardTab=e=>{if(document.activeElement===firstFocusableEl){e.preventDefault();lastFocusableEl.focus();}};const handleForwardTab=e=>{if(document.activeElement===lastFocusableEl){e.preventDefault();firstFocusableEl.focus();}};const onKeyDown=e=>{switch(e.key){case utils/* KEY_CODES */.Lb.ESCAPE:case utils/* KEY_CODES */.Lb.ESCAPE_IE11:{setMenuOpen(false);break;}case utils/* KEY_CODES */.Lb.TAB:{if(menuFocusables&&menuFocusables.length===1){e.preventDefault();break;}if(e.shiftKey){handleBackwardTab(e);}else{handleForwardTab(e);}break;}default:{break;}}};const onResize=e=>{if(e.currentTarget.innerWidth>768){setMenuOpen(false);}};(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{document.addEventListener('keydown',onKeyDown);window.addEventListener('resize',onResize);setFocusables();return()=>{document.removeEventListener('keydown',onKeyDown);window.removeEventListener('resize',onResize);};},[]);const wrapperRef=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)();(0,hooks/* useOnClickOutside */.Wr)(wrapperRef,()=>setMenuOpen(false));return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledMenu,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Helmet.Helmet,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("body",{className:menuOpen?'blur':''})),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{ref:wrapperRef},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledHamburgerButton,{onClick:toggleMenu,menuOpen:menuOpen,ref:buttonRef,"aria-label":"Menu"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"ham-box"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"ham-box-inner"}))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledSidebar,{menuOpen:menuOpen,"aria-hidden":!menuOpen,tabIndex:menuOpen?1:-1},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("nav",{ref:navRef},config.navLinks&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("ol",null,config.navLinks.map(({url,name},i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("li",{key:i},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:url,onClick:()=>setMenuOpen(false)},name))))))));};/* harmony default export */ const menu = (Menu);
;// ./src/components/side.js
const StyledSideElement=styled_components_esm["default"].div.withConfig({displayName:"side__StyledSideElement",componentId:"sc-1duznzb-0"})(["width:40px;position:fixed;bottom:0;left:",";right:",";z-index:10;color:var(--light-slate);@media (max-width:1080px){left:",";right:",";}@media (max-width:768px){display:none;}"],props=>props.orientation==='left'?'40px':'auto',props=>props.orientation==='left'?'auto':'40px',props=>props.orientation==='left'?'20px':'auto',props=>props.orientation==='left'?'auto':'20px');const Side=({children,isHome,orientation})=>{const{0:isMounted,1:setIsMounted}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(!isHome);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.jt)();(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(!isHome||prefersReducedMotion){return;}const timeout=setTimeout(()=>setIsMounted(true),utils/* loaderDelay */.Zc);return()=>clearTimeout(timeout);},[]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledSideElement,{orientation:orientation},prefersReducedMotion?/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,children):/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroup/* default */.A,{component:null},isMounted&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{classNames:isHome?'fade':'',timeout:isHome?utils/* loaderDelay */.Zc:0},children)));};Side.propTypes={children:(prop_types_default()).node.isRequired,isHome:(prop_types_default()).bool,orientation:(prop_types_default()).string};/* harmony default export */ const side = (Side);
;// ./src/components/social.js
const StyledSocialList=styled_components_esm["default"].ul.withConfig({displayName:"social__StyledSocialList",componentId:"sc-anu6nt-0"})(["display:flex;flex-direction:column;align-items:center;margin:0;padding:0;list-style:none;&:after{content:'';display:block;width:1px;height:90px;margin:0 auto;background-color:var(--light-slate);}li{&:last-of-type{margin-bottom:20px;}a{padding:10px;&:hover,&:focus{transform:translateY(-3px);}svg{width:20px;height:20px;}}}"]);const Social=({isHome})=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(side,{isHome:isHome,orientation:"left"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledSocialList,null,config.socialMedia&&config.socialMedia.map(({url,name},i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("li",{key:i},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:url,"aria-label":name,target:"_blank",rel:"noreferrer"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:name}))))));Social.propTypes={isHome:(prop_types_default()).bool};/* harmony default export */ const social = (Social);
;// ./src/components/email.js
const StyledLinkWrapper=styled_components_esm["default"].div.withConfig({displayName:"email__StyledLinkWrapper",componentId:"sc-2epoq-0"})(["display:flex;flex-direction:column;align-items:center;position:relative;&:after{content:'';display:block;width:1px;height:90px;margin:0 auto;background-color:var(--light-slate);}a{margin:20px auto;padding:10px;font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:var(--fz-lg);letter-spacing:0.1em;writing-mode:vertical-rl;&:hover,&:focus{transform:translateY(-3px);}}"]);const Email=({isHome})=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(side,{isHome:isHome,orientation:"right"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledLinkWrapper,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:`mailto:${config.email}`},config.email)));Email.propTypes={isHome:(prop_types_default()).bool};/* harmony default export */ const email = (Email);
;// ./src/components/footer.js
const StyledFooter=styled_components_esm["default"].footer.withConfig({displayName:"footer__StyledFooter",componentId:"sc-4jwnt4-0"})(["",";flex-direction:column;height:auto;min-height:70px;padding:15px;text-align:center;"],({theme})=>theme.mixins.flexCenter);const StyledSocialLinks=styled_components_esm["default"].div.withConfig({displayName:"footer__StyledSocialLinks",componentId:"sc-4jwnt4-1"})(["display:none;@media (max-width:768px){display:block;width:100%;max-width:270px;margin:0 auto 10px;color:var(--light-slate);}ul{",";padding:0;margin:0;list-style:none;a{padding:10px;svg{width:20px;height:20px;}}}"],({theme})=>theme.mixins.flexBetween);const StyledCredit=styled_components_esm["default"].div.withConfig({displayName:"footer__StyledCredit",componentId:"sc-4jwnt4-2"})(["color:var(--light-slate);font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:1;a{padding:10px;}.github-stats{margin-top:10px;& > span{display:inline-flex;align-items:center;margin:0 7px;}svg{display:inline-block;margin-right:5px;width:14px;height:14px;}}"]);const Footer=()=>{const{0:githubInfo,1:setGitHubInfo}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)({stars:null,forks:null});(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(false)// removed by dead control flow
{}fetch('https://api.github.com/users/Shirshakhtml').then(response=>response.json()).then(json=>{const{stargazers_count,forks_count}=json;setGitHubInfo({stars:stargazers_count,forks:forks_count});}).catch(e=>console.error(e));},[]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledFooter,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledSocialLinks,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("ul",null,config.socialMedia&&config.socialMedia.map(({name,url},i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("li",{key:i},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:url,"aria-label":name},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:name})))))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledCredit,{tabindex:"-1"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:"https://github.com/Shirshakhtml/"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",null,"Designed & Built by Shirshak Roy"),githubInfo.stars&&githubInfo.forks&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"github-stats"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"Star"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",null,githubInfo.stars.toLocaleString())),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"Fork"}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",null,githubInfo.forks.toLocaleString()))))));};Footer.propTypes={githubInfo:(prop_types_default()).object};/* harmony default export */ const footer = (Footer);
;// ./src/components/sections/hero.js
const StyledHeroSection=styled_components_esm["default"].section.withConfig({displayName:"hero__StyledHeroSection",componentId:"sc-116xg8t-0"})(["",";flex-direction:column;align-items:flex-start;min-height:100vh;height:100vh;padding:0;@media (max-height:700px) and (min-width:700px),(max-width:360px){height:auto;padding-top:var(--nav-height);}h1{margin:0 0 30px 4px;color:var(--green);font-family:var(--font-mono);font-size:clamp(var(--fz-sm),5vw,var(--fz-md));font-weight:400;@media (max-width:480px){margin:0 0 20px 2px;}}h3{margin-top:5px;color:var(--slate);line-height:0.9;}p{margin:20px 0 0;max-width:540px;}.email-link{",";margin-top:50px;}"],({theme})=>theme.mixins.flexCenter,({theme})=>theme.mixins.bigButton);const Hero=()=>{const{0:isMounted,1:setIsMounted}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(false);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.jt)();(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}const timeout=setTimeout(()=>setIsMounted(true),utils/* navDelay */.LF);return()=>clearTimeout(timeout);},[]);const one=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h1",null,"Hi, my name is");const two=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h2",{className:"big-heading"},"Shirshak Roy.");const three=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h3",{className:"big-heading"},"I break into systems",' ',/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",{className:"highlight"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("u",null,"ETHICALLY")),' ',"so others can sleep soundly.");const four=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("p",null,"I\u2019m a Cyber Security Engineer at",' ',/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:"https://secnora.com/",target:"_blank",rel:"noreferrer"},"Secnora"),", and a passionate, results-driven professional specializing in penetration testing across web applications, networks, APIs, mobile apps, and Active Directory environments. My goal is to help organizations strengthen their security posture through frequent Vulnerability Assessments and Security Audit."));const five=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{className:"email-link",href:"https://www.linkedin.com/in/shirshak-pentester/",target:"_blank",rel:"noopener noreferrer"},"Check out my LinkedIn profile!");const items=[one,two,three,four,five];return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledHeroSection,null,prefersReducedMotion?/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,items.map((item,i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{key:i},item))):/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroup/* default */.A,{component:null},isMounted&&items.map((item,i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{key:i,classNames:"fadeup",timeout:utils/* loaderDelay */.Zc},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{style:{transitionDelay:`${i+1}00ms`}},item)))));};/* harmony default export */ const hero = (Hero);
...
(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>focusTab(),[tabFocus]);// Focus on tabs when using up & down arrow keys
const onKeyDown=e=>{switch(e.key){case utils/* KEY_CODES */.Lb.ARROW_UP:{e.preventDefault();setTabFocus(tabFocus-1);break;}case utils/* KEY_CODES */.Lb.ARROW_DOWN:{e.preventDefault();setTabFocus(tabFocus+1);break;}default:{break;}}};return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledJobsSection,{id:"jobs",ref:revealContainer},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h2",{className:"numbered-heading"},"Where I\u2019ve Worked"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"inner"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledTabList,{role:"tablist","aria-label":"Job tabs",onKeyDown:e=>onKeyDown(e)},jobsData&&jobsData.map(({node},i)=>{const{company}=node.frontmatter;return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledTabButton,{key:i,isActive:activeTabId===i,onClick:()=>setActiveTabId(i),ref:el=>tabs.current[i]=el,id:`tab-${i}`,role:"tab",tabIndex:activeTabId===i?'0':'-1',"aria-selected":activeTabId===i?true:false,"aria-controls":`panel-${i}`},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",null,company));}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledHighlight,{activeTabId:activeTabId})),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledTabPanels,null,jobsData&&jobsData.map(({node},i)=>{const{frontmatter,html}=node;const{title,url,company,range}=frontmatter;return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{key:i,in:activeTabId===i,timeout:250,classNames:"fade"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledTabPanel,{id:`panel-${i}`,role:"tabpanel",tabIndex:activeTabId===i?'0':'-1',"aria-labelledby":`tab-${i}`,"aria-hidden":activeTabId!==i,hidden:activeTabId!==i},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h3",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",null,title),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("span",{className:"company"},"\xA0@\xA0",/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:url,className:"inline-link"},company))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("p",{className:"range"},range),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{dangerouslySetInnerHTML:{__html:html}})));}))));};/* harmony default export */ const jobs = (Jobs);
;// ./src/components/sections/featured.js
const StyledProjectsGrid=styled_components_esm["default"].ul.withConfig({displayName:"featured__StyledProjectsGrid",componentId:"sc-ywnbqt-0"})(["",";a{position:relative;z-index:1;}"],({theme})=>theme.mixins.resetList);const StyledProject=styled_components_esm["default"].li.withConfig({displayName:"featured__StyledProject",componentId:"sc-ywnbqt-1"})(["position:relative;display:grid;grid-gap:10px;grid-template-columns:repeat(12,1fr);align-items:center;@media (max-width:768px){",";}&:not(:last-of-type){margin-bottom:100px;@media (max-width:768px){margin-bottom:70px;}@media (max-width:480px){margin-bottom:30px;}}&:nth-of-type(odd){.project-content{grid-column:7 / -1;text-align:right;@media (max-width:1080px){grid-column:5 / -1;}@media (max-width:768px){grid-column:1 / -1;padding:40px 40px 30px;text-align:left;}@media (max-width:480px){padding:25px 25px 20px;}}.project-tech-list{justify-content:flex-end;@media (max-width:768px){justify-content:flex-start;}li{margin:0 0 5px 20px;@media (max-width:768px){margin:0 10px 5px 0;}}}.project-links{justify-content:flex-end;margin-left:0;margin-right:-10px;@media (max-width:768px){justify-content:flex-start;margin-left:-10px;margin-right:0;}}.project-image{grid-column:1 / 8;@media (max-width:768px){grid-column:1 / -1;}}}.project-content{position:relative;grid-column:1 / 7;grid-row:1 / -1;@media (max-width:1080px){grid-column:1 / 9;}@media (max-width:768px){display:flex;flex-direction:column;justify-content:center;height:100%;grid-column:1 / -1;padding:40px 40px 30px;z-index:5;}@media (max-width:480px){padding:30px 25px 20px;}}.project-overline{margin:10px 0;color:var(--green);font-family:var(--font-mono);font-size:var(--fz-xs);font-weight:400;}.project-title{color:var(--lightest-slate);font-size:clamp(24px,5vw,28px);@media (min-width:768px){margin:0 0 20px;}@media (max-width:768px){color:var(--white);a{position:static;&:before{content:'';display:block;position:absolute;z-index:0;width:100%;height:100%;top:0;left:0;}}}}.project-description{",";position:relative;z-index:2;padding:25px;border-radius:var(--border-radius);background-color:var(--light-navy);color:var(--light-slate);font-size:var(--fz-lg);@media (max-width:768px){padding:20px 0;background-color:transparent;box-shadow:none;&:hover{box-shadow:none;}}a{",";}strong{color:var(--white);font-weight:normal;}}.project-tech-list{display:flex;flex-wrap:wrap;position:relative;z-index:2;margin:25px 0 10px;padding:0;list-style:none;li{margin:0 20px 5px 0;color:var(--light-slate);font-family:var(--font-mono);font-size:var(--fz-xs);white-space:nowrap;}@media (max-width:768px){margin:10px 0;li{margin:0 10px 5px 0;color:var(--lightest-slate);}}}.project-links{display:flex;align-items:center;position:relative;margin-top:10px;margin-left:-10px;color:var(--lightest-slate);a{",";padding:10px;&.external{svg{width:22px;height:22px;margin-top:-4px;}}svg{width:20px;height:20px;}}.cta{",";margin:10px;}}.project-image{",";grid-column:6 / -1;grid-row:1 / -1;position:relative;z-index:1;@media (max-width:768px){grid-column:1 / -1;height:100%;opacity:0.25;}a{width:100%;height:100%;background-color:var(--green);border-radius:var(--border-radius);vertical-align:middle;&:hover,&:focus{background:transparent;outline:0;&:before,.img{background:transparent;filter:none;}}&:before{content:'';position:absolute;width:100%;height:100%;top:0;left:0;right:0;bottom:0;z-index:3;transition:var(--transition);background-color:var(--navy);mix-blend-mode:screen;}}.img{border-radius:var(--border-radius);mix-blend-mode:multiply;filter:grayscale(100%) contrast(1) brightness(90%);@media (max-width:768px){object-fit:cover;width:auto;height:100%;filter:grayscale(100%) contrast(1) brightness(50%);}}}"],({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.inlineLink,({theme})=>theme.mixins.flexCenter,({theme})=>theme.mixins.smallButton,({theme})=>theme.mixins.boxShadow);const Featured=()=>{const data=(0,gatsby_browser_entry.useStaticQuery)("2031412112");const featuredProjects=data.featured.edges.filter(({node})=>node);const revealTitle=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);const revealProjects=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)([]);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.jt)();(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default */.A.reveal(revealTitle.current,(0,config.srConfig)());revealProjects.current.forEach((ref,i)=>sr/* default */.A.reveal(ref,(0,config.srConfig)(i*100)));},[]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("section",{id:"projects"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h2",{className:"numbered-heading",ref:revealTitle},"Some Things I\u2019ve Built"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledProjectsGrid,null,featuredProjects&&featuredProjects.map(({node},i)=>{const{frontmatter,html}=node;const{external,title,tech,github,cover,cta}=frontmatter;const image=R(cover);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledProject,{key:i,ref:el=>revealProjects.current[i]=el},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-content"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("p",{className:"project-overline"},"Featured Project"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h3",{className:"project-title"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:external},title)),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-description",dangerouslySetInnerHTML:{__html:html}}),tech.length&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("ul",{className:"project-tech-list"},tech.map((tech,i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("li",{key:i},tech))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-links"},cta&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:cta,"aria-label":"Course Link",className:"cta"},"Learn More"),github&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:github,"aria-label":"GitHub Link"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"GitHub"})),external&&!cta&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:external,"aria-label":"External Link",className:"external"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"External"}))))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-image"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:external?external:github?github:'#'},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Y,{image:image,alt:title,className:"img"}))));})));};/* harmony default export */ const featured = (Featured);
;// ./src/components/sections/projects.js
const StyledProjectsSection=styled_components_esm["default"].section.withConfig({displayName:"projects__StyledProjectsSection",componentId:"sc-1v1fime-0"})(["display:flex;flex-direction:column;align-items:center;h2{font-size:clamp(24px,5vw,var(--fz-heading));}.archive-link{font-family:var(--font-mono);font-size:var(--fz-sm);&:after{bottom:0.1em;}}.projects-grid{",";display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));grid-gap:15px;position:relative;margin-top:50px;@media (max-width:1080px){grid-template-columns:repeat(auto-fill,minmax(250px,1fr));}}.more-button{",";margin:80px auto 0;}"],({theme})=>theme.mixins.resetList,({theme})=>theme.mixins.button);const projects_StyledProject=styled_components_esm["default"].li.withConfig({displayName:"projects__StyledProject",componentId:"sc-1v1fime-1"})(["position:relative;cursor:default;transition:var(--transition);@media (prefers-reduced-motion:no-preference){&:hover,&:focus-within{.project-inner{transform:translateY(-7px);}}}a{position:relative;z-index:1;}.project-inner{",";",";flex-direction:column;align-items:flex-start;position:relative;height:100%;padding:2rem 1.75rem;border-radius:var(--border-radius);background-color:var(--light-navy);transition:var(--transition);overflow:auto;}.project-top{",";margin-bottom:35px;.folder{color:var(--green);svg{width:40px;height:40px;}}.project-links{display:flex;align-items:center;margin-right:-10px;color:var(--light-slate);a{",";padding:5px 7px;&.external{svg{width:22px;height:22px;margin-top:-4px;}}svg{width:20px;height:20px;}}}}.project-title{margin:0 0 10px;color:var(--lightest-slate);font-size:var(--fz-xxl);a{position:static;&:before{content:'';display:block;position:absolute;z-index:0;width:100%;height:100%;top:0;left:0;}}}.project-description{color:var(--light-slate);font-size:17px;a{",";}}.project-tech-list{display:flex;align-items:flex-end;flex-grow:1;flex-wrap:wrap;padding:0;margin:20px 0 0 0;list-style:none;li{font-family:var(--font-mono);font-size:var(--fz-xxs);line-height:1.75;&:not(:last-of-type){margin-right:15px;}}}"],({theme})=>theme.mixins.boxShadow,({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexBetween,({theme})=>theme.mixins.flexCenter,({theme})=>theme.mixins.inlineLink);const Projects=()=>{const data=(0,gatsby_browser_entry.useStaticQuery)("3825832676");const{0:showMore,1:setShowMore}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(false);const revealTitle=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);const revealArchiveLink=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);const revealProjects=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)([]);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.jt)();(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default */.A.reveal(revealTitle.current,(0,config.srConfig)());sr/* default */.A.reveal(revealArchiveLink.current,(0,config.srConfig)());revealProjects.current.forEach((ref,i)=>sr/* default */.A.reveal(ref,(0,config.srConfig)(i*100)));},[]);const GRID_LIMIT=6;const projects=data.projects.edges.filter(({node})=>node);const firstSix=projects.slice(0,GRID_LIMIT);const projectsToShow=showMore?projects:firstSix;const projectInner=node=>{const{frontmatter,html}=node;const{github,external,title,tech}=frontmatter;return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-inner"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("header",null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-top"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"folder"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"Folder"})),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-links"},github&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:github,"aria-label":"GitHub Link",target:"_blank",rel:"noreferrer"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"GitHub"})),external&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:external,"aria-label":"External Link",className:"external",target:"_blank",rel:"noreferrer"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(icons/* Icon */.In,{name:"External"})))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h3",{className:"project-title"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{href:external,target:"_blank",rel:"noreferrer"},title)),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{className:"project-description",dangerouslySetInnerHTML:{__html:html}})),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("footer",null,tech&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("ul",{className:"project-tech-list"},tech.map((tech,i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("li",{key:i},tech)))));};return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledProjectsSection,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h2",{ref:revealTitle},"Other Noteworthy Projects"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{className:"inline-link archive-link",to:"/archive",ref:revealArchiveLink},"view the archive"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("ul",{className:"projects-grid"},prefersReducedMotion?/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,projectsToShow&&projectsToShow.map(({node},i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(projects_StyledProject,{key:i},projectInner(node)))):/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroup/* default */.A,{component:null},projectsToShow&&projectsToShow.map(({node},i)=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(CSSTransition/* default */.A,{key:i,classNames:"fadeup",timeout:i>=GRID_LIMIT?(i-GRID_LIMIT)*300:300,exit:false},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(projects_StyledProject,{key:i,ref:el=>revealProjects.current[i]=el,style:{transitionDelay:`${i>=GRID_LIMIT?(i-GRID_LIMIT)*100:0}ms`}},projectInner(node)))))),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("button",{className:"more-button",onClick:()=>setShowMore(!showMore)},"Show ",showMore?'Less':'More'));};/* harmony default export */ const projects = (Projects);
;// ./src/components/sections/contact.js
const StyledContactSection=styled_components_esm["default"].section.withConfig({displayName:"contact__StyledContactSection",componentId:"sc-1m8df4t-0"})(["max-width:600px;margin:0 auto 100px;text-align:center;@media (max-width:768px){margin:0 auto 50px;}.overline{display:block;margin-bottom:20px;color:var(--green);font-family:var(--font-mono);font-size:var(--fz-md);font-weight:400;&:before{bottom:0;font-size:var(--fz-sm);}&:after{display:none;}}.title{font-size:clamp(40px,5vw,60px);}.email-link{",";margin-top:50px;}"],({theme})=>theme.mixins.bigButton);const Contact=()=>{const revealContainer=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useRef)(null);const prefersReducedMotion=(0,hooks/* usePrefersReducedMotion */.jt)();(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(prefersReducedMotion){return;}sr/* default */.A.reveal(revealContainer.current,(0,config.srConfig)());},[]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledContactSection,{id:"contact",ref:revealContainer},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h2",{className:"numbered-heading overline"},"What\u2019s Next?"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("h2",{className:"title"},"Get In Touch"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("p",null,"Although I\u2019m not currently looking for any new opportunities, my inbox is always open. Whether you have a question or just want to say hi, I\u2019ll try my best to get back to you!"),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{className:"email-link",href:`mailto:${config.email}`},"Say Hello"));};/* harmony default export */ const contact = (Contact);
...
function getChildMapping(children, mapFn) {
  var mapper = function mapper(child) {
    return mapFn && (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.isValidElement)(child) ? mapFn(child) : child;
  };

  var result = Object.create(null);
  if (children) external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.Children.map(children, function (c) {
    return c;
...
function getInitialChildMapping(props, onExited) {
  return getChildMapping(props.children, function (child) {
    return (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.cloneElement)(child, {
...
function getNextChildMapping(nextProps, prevChildMapping, onExited) {
  ...
  Object.keys(children).forEach(function (key) {
    ...
    if (!(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.isValidElement)(child)) return;
    var hasPrev = (key in prevChildMapping);
    var hasNext = (key in nextChildMapping);
    var prevChild = prevChildMapping[key];
    var isLeaving = (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.isValidElement)(prevChild) && !prevChild.props.in; // item is new (entering)

    if (hasNext && (!hasPrev || isLeaving)) {
      // console.log('entering', key)
      children[key] = (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.cloneElement)(child, {
        onExited: onExited.bind(null, child),
        in: true,
    ...
    } else if (hasNext && hasPrev && (0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.isValidElement)(prevChild)) {
...
var TransitionGroup = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    if (Component === null) {
      return /*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroupContext/* default */.A.Provider, {
        value: contextValue
      }, children);
    }
    ...
    return /*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroupContext/* default */.A.Provider, {
      value: contextValue
    }, /*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(Component, props, children));
  };
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1864);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1929);
/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_config__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils_sr__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9636);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4031);
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(3208);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1378);
const StyledTableContainer=styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div.withConfig({displayName:"archive__StyledTableContainer",componentId:"sc-2cxdc9-0"})(["margin:100px -20px;@media (max-width:768px){margin:50px -10px;}table{width:100%;border-collapse:collapse;.hide-on-mobile{@media (max-width:768px){display:none;}}tbody tr{&:hover,&:focus{background-color:var(--light-navy);}}th,td{padding:10px;text-align:left;&:first-child{padding-left:20px;@media (max-width:768px){padding-left:10px;}}&:last-child{padding-right:20px;@media (max-width:768px){padding-right:10px;}}svg{width:20px;height:20px;}}tr{cursor:default;td:first-child{border-top-left-radius:var(--border-radius);border-bottom-left-radius:var(--border-radius);}td:last-child{border-top-right-radius:var(--border-radius);border-bottom-right-radius:var(--border-radius);}}td{&.year{padding-right:20px;@media (max-width:768px){padding-right:10px;font-size:var(--fz-sm);}}&.title{padding-top:15px;padding-right:20px;color:var(--lightest-slate);font-size:var(--fz-xl);font-weight:600;line-height:1.25;}&.company{font-size:var(--fz-lg);white-space:nowrap;}&.tech{font-size:var(--fz-xxs);font-family:var(--font-mono);line-height:1.5;.separator{margin:0 5px;}span{display:inline-block;}}&.links{min-width:100px;div{display:flex;align-items:center;a{",";flex-shrink:0;}a + a{margin-left:10px;}}}}}"],({theme})=>theme.mixins.flexCenter);const ArchivePage=({location,data})=>{const projects=data.allMarkdownRemark.edges;const revealTitle=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);const revealTable=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);const revealProjects=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)([]);const prefersReducedMotion=(0,_hooks__WEBPACK_IMPORTED_MODULE_8__/* .usePrefersReducedMotion */ .jt)();(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(prefersReducedMotion){return;}_utils_sr__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.reveal(revealTitle.current,(0,_config__WEBPACK_IMPORTED_MODULE_4__.srConfig)());_utils_sr__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.reveal(revealTable.current,(0,_config__WEBPACK_IMPORTED_MODULE_4__.srConfig)(200,0));revealProjects.current.forEach((ref,i)=>_utils_sr__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A.reveal(ref,(0,_config__WEBPACK_IMPORTED_MODULE_4__.srConfig)(i*10)));},[]);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_6__/* .Layout */ .PE,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__.Helmet,{title:"Archive"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("header",{ref:revealTitle},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{className:"big-heading"},"Archive"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"subtitle"},"A big list of things I\u2019ve worked on")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTableContainer,{ref:revealTable},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("table",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("thead",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",null,"Year"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",null,"Title"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",{className:"hide-on-mobile"},"Made at"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",{className:"hide-on-mobile"},"Built with"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th",null,"Link"))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody",null,projects.length>0&&projects.map(({node},i)=>{const{date,github,external,ios,android,title,tech,company}=node.frontmatter;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr",{key:i,ref:el=>revealProjects.current[i]=el},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"overline year"},`${new Date(date).getFullYear()}`),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"title"},title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"company hide-on-mobile"},company?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,company):/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,"\u2014")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"tech hide-on-mobile"},(tech===null||tech===void 0?void 0:tech.length)>0&&tech.map((item,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{key:i},item,'',i!==tech.length-1&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",{className:"separator"},"\xB7")))),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td",{className:"links"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,external&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:external,"aria-label":"External Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_7__/* .Icon */ .In,{name:"External"})),github&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:github,"aria-label":"GitHub Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_7__/* .Icon */ .In,{name:"GitHub"})),ios&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:ios,"aria-label":"Apple App Store Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_7__/* .Icon */ .In,{name:"AppStore"})),android&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("a",{href:android,"aria-label":"Google Play Store Link"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_icons__WEBPACK_IMPORTED_MODULE_7__/* .Icon */ .In,{name:"PlayStore"})))));}))))));};ArchivePage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().object).isRequired,data:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ArchivePage);const pageQuery="357801700";
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`)// removed by dead control flow
{}const context=external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4031);
const StyledMainContainer=styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].main.withConfig({displayName:"pages__StyledMainContainer",componentId:"sc-1tzx2o8-0"})(["counter-reset:section;"]);const IndexPage=({location})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Layout */ .PE,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,{className:"fillHeight"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Hero */ .lq,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .About */ .Im,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Jobs */ .XP,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Featured */ .Hi,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Projects */ .Jt,null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_3__/* .Contact */ .Bv,null)));IndexPage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage);
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(493),options:{"plugins":[]}},{name:'gatsby-plugin-styled-components',plugin:__webpack_require__(8360),options:{"plugins":[],"displayName":true,"fileName":true,"minify":true,"namespace":"","transpileTemplateLiterals":true,"topLevelImportPaths":[],"pure":false,"disableVendorPrefixes":false}},{name:'gatsby-plugin-image',plugin:__webpack_require__(3009),options:{"plugins":[]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(8899),options:{"plugins":[],"output":"/sitemap","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }","excludes":[]}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(6887),options:{"plugins":[],"name":"Shirshak Roy","short_name":"Shirshak Roy","start_url":"/","background_color":"#020c1b","theme_color":"#0a192f","display":"minimal-ui","icon":"src/images/logo.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"86d43a53672fbf993da1edeff47cc513"}},{name:'gatsby-plugin-offline',plugin:__webpack_require__(6587),options:{"plugins":[]}},{name:'gatsby-plugin-google-analytics',plugin:__webpack_require__(958),options:{"plugins":[],"trackingId":"UA-45666519-2","head":false,"anonymize":false,"respectDNT":false,"exclude":[],"pageTransitionDelay":0,"enableWebVitalsTracking":false}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
var Transition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(TransitionGroupContext/* default */.A.Provider, {
        value: null
      }, typeof children === 'function' ? children(status, childProps) : external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().cloneElement(external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().Children.only(children), childProps))
    );
  };
...
var CSSTransition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(esm_Transition, (0,esm_extends/* default */.A)({}, props, {
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(6585));var _gatsby=__webpack_require__(5575);var _common=__webpack_require__(9975);var _getManifestPathname=_interopRequireDefault(__webpack_require__(3901));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5575);
/* harmony import */ var react_helmet__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8154);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6488);
/* harmony import */ var react_transition_group__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(4038);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(1597);
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(4031);
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1378);
const StyledMainContainer=styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].main.withConfig({displayName:"sc-404__StyledMainContainer",componentId:"sc-bnxlhm-0"})(["",";flex-direction:column;"],({theme})=>theme.mixins.flexCenter);const StyledTitle=styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].h1.withConfig({displayName:"sc-404__StyledTitle",componentId:"sc-bnxlhm-1"})(["color:var(--green);font-family:var(--font-mono);font-size:clamp(100px,25vw,200px);line-height:1;"]);const StyledSubtitle=styled_components__WEBPACK_IMPORTED_MODULE_6__["default"].h2.withConfig({displayName:"sc-404__StyledSubtitle",componentId:"sc-bnxlhm-2"})(["font-size:clamp(30px,5vw,50px);font-weight:400;"]);const StyledHomeButton=(0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link).withConfig({displayName:"sc-404__StyledHomeButton",componentId:"sc-bnxlhm-3"})(["",";margin-top:40px;"],({theme})=>theme.mixins.bigButton);const NotFoundPage=({location})=>{const{0:isMounted,1:setIsMounted}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);const prefersReducedMotion=(0,_hooks__WEBPACK_IMPORTED_MODULE_9__/* .usePrefersReducedMotion */ .jt)();(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(prefersReducedMotion){return;}const timeout=setTimeout(()=>setIsMounted(true),_utils__WEBPACK_IMPORTED_MODULE_7__/* .navDelay */ .LF);return()=>clearTimeout(timeout);},[]);const content=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledMainContainer,{className:"fillHeight"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledTitle,null,"404"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledSubtitle,null,"Page Not Found"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(StyledHomeButton,{to:"/"},"Go Home"));return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components__WEBPACK_IMPORTED_MODULE_8__/* .Layout */ .PE,{location:location},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_2__.Helmet,{title:"Page Not Found"}),prefersReducedMotion?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,content):/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A,{component:null},isMounted&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_transition_group__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,{timeout:500,classNames:"fadeup"},content)));};NotFoundPage.propTypes={location:(prop_types__WEBPACK_IMPORTED_MODULE_5___default().object).isRequired};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (NotFoundPage);
...
var _react = _interopRequireDefault(__webpack_require__(6585));
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6585);
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var _react=_interopRequireDefault(__webpack_require__(6585));var _styledComponents=__webpack_require__(1864);var sheetByPathname=new Map();// eslint-disable-next-line react/prop-types,react/display-name
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5556);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
function SEO({title,description}){const siteTitle='Shirshak Roy';// ← your site title
const fullTitle=title?`${title} | ${siteTitle}`:siteTitle;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title",null,fullTitle),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{name:"description",content:description||'A cyber-themed portfolio'}));}SEO.propTypes={title:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().string),description:(prop_types__WEBPACK_IMPORTED_MODULE_1___default().string)};
...
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.esm.js + 4 modules
var styled_components_esm = __webpack_require__(1864);
// EXTERNAL MODULE: ./src/components/index.js + 15 modules
var components = __webpack_require__(4031);
...
const isBrowser=typeof window!=='undefined';const safeLocation=isBrowser?window.location:{hash:''};const StyledContent=styled_components_esm["default"].div.withConfig({displayName:"layout__StyledContent",componentId:"sc-1yw8zls-0"})(["display:flex;flex-direction:column;min-height:100vh;"]);const Layout=({children,location,isHome:explicitIsHome})=>{// 1.  use explicit prop if given, else compute from location
const detectedIsHome=(location===null||location===void 0?void 0:location.pathname)==='/';const isHome=explicitIsHome!==undefined?explicitIsHome:detectedIsHome;const{0:isLoading,1:setIsLoading}=(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useState)(isHome);const handleExternalLinks=()=>{const allLinks=Array.from(document.querySelectorAll('a'));if(allLinks.length>0){allLinks.forEach(link=>{if(link.host!==window.location.host){link.setAttribute('rel','noopener noreferrer');link.setAttribute('target','_blank');}});}};(0,external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_.useEffect)(()=>{if(isLoading)return;if(safeLocation.hash){const id=safeLocation.hash.substring(1);setTimeout(()=>{const el=document.getElementById(id);if(el){el.scrollIntoView();el.focus();}},0);}handleExternalLinks();},[isLoading]);return/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement((external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(components/* Head */.p3,null),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{id:"root"},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(styled_components_esm.ThemeProvider,{theme:styles_theme},/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(styles_GlobalStyle,null),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("a",{className:"skip-to-content",href:"#content"},"Skip to Content"),isLoading&&isHome?/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(components/* Loader */.aH,{finishLoading:()=>setIsLoading(false)}):/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(StyledContent,null,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(components/* Nav */.so,{isHome:isHome}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(components/* Social */.Gz,{isHome:isHome}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(components/* Email */.Ps,{isHome:isHome}),/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement("div",{id:"content"},children,/*#__PURE__*/external_D_myfiles_portfolio_cyber_portfolio_node_modules_react_index_js_default().createElement(components/* Footer */.wi,null))))));};Layout.propTypes={children:(prop_types_default()).node.isRequired,location:(prop_types_default()).object.isRequired,isHome:(prop_types_default()).bool// <-- new
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(6585));var _gatsby=__webpack_require__(5575);var _path=__webpack_require__(2003);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
"use strict";
module.exports = require("D:\\myfiles\\portfolio\\cyber-portfolio\\.cache\\ssr-builtin-trackers\\fs");
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6585);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1864);
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8785);
/* harmony import */ var _components_seo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8629);
/* ---------- HEADER IMAGE ---------- */const HeaderImage=styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({displayName:"blog-post__HeaderImage",componentId:"sc-upp0c-0"})(["width:100%;height:320px;background-size:cover;background-position:center;border-radius:16px;margin-bottom:2rem;background-repeat:no-repeat;"]);/* ---------- POST CONTAINER ---------- */const BlogPostContainer=styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].article.withConfig({displayName:"blog-post__BlogPostContainer",componentId:"sc-upp0c-1"})(["max-width:900px;margin:140px auto 80px;padding:2rem 2.5rem;background:rgba(10,25,47,0.55);border:1px solid rgba(100,255,218,0.15);border-radius:16px;backdrop-filter:blur(12px);color:#ccd6f6;line-height:1.7;box-shadow:0 0 30px rgba(0,0,0,0.25);h1{color:#64ffda;margin-bottom:0.6rem;font-size:2rem;}.date{color:#8892b0;margin-bottom:1.5rem;font-size:0.95rem;}p{margin-bottom:1.2rem;}img{max-width:100%;border-radius:12px;margin:2rem 0;box-shadow:0 0 15px rgba(0,255,200,0.15);}a{color:#64ffda;border-bottom:1px solid rgba(100,255,218,0.4);}"]);/* ---------- SAFE IMAGE RESOLVER ---------- */const resolveImage=imageField=>{if(!imageField)return"/default.jpg";return imageField.publicURL||"/default.jpg";};function BlogPost({data}){const{html,frontmatter}=data.markdownRemark;const headerImage=resolveImage(frontmatter.image);return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,{title:frontmatter.title,description:frontmatter.description}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(HeaderImage,{style:{backgroundImage:`url(${headerImage})`}}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(BlogPostContainer,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",null,frontmatter.title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",{className:"date"},frontmatter.date),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{dangerouslySetInnerHTML:{__html:html}})));}/* ---------- GRAPHQL ---------- */const query="1427632712";
...
/* harmony export */ });
const React=__webpack_require__(6585);const path=__webpack_require__(2003);const{renderToString,renderToStaticMarkup,pipeToNodeWritable}=__webpack_require__(303);const{ServerLocation,Router,isRedirect}=__webpack_require__(1693);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(5575);const fs=__webpack_require__(9008);const{WritableAsPromise}=__webpack_require__(9348);const{RouteAnnouncerProps}=__webpack_require__(5259);const{apiRunner,apiRunnerAsync}=__webpack_require__(5943);const syncRequires=__webpack_require__(2905);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(1173);const chunkMapping=__webpack_require__(3114);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
